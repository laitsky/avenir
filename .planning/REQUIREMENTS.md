...
**Reopened requirements:** `BET-02`, `INF-07`, `RES-03`, `RES-05`, `RES-06`, `RTG-01`

**Deferred optional audit cleanup (not reopened in this pass):**
- `INF-02` runtime benchmark/DKG validation
- `UX-08` explicit evidence cleanup
...
| RES-03 | Phase 8: Dispute System, Phase 11: Gap Closure, Phase 14: Repair Dispute Escalation Account Ordering | Pending |
...
| RTG-01 | Phase 10: RTG Submission, Phase 16: RTG Publication And Audit Drift Cleanup | Pending |
| RTG-02 | Phase 10: RTG Submission | Complete |
| RTG-03 | Phase 10: RTG Submission | Complete |

**Coverage:**
- v1 requirements: 38 total
- Pending gap closures: 6
- Marked complete: 32
- Unmapped: 0
